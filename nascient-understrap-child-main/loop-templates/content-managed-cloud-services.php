...
/**
 * Content Managed Cloud Solutions partial template
 *
 * @package Understrap
 */
...
<?php if (have_rows('managed_cloud_services_layout')) : ?>
    <?php while (have_rows('managed_cloud_services_layout')) : the_row();
