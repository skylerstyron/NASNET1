<div class="d-flex justify-content-around align-items-center">
    <div class="col-10 card container-card rounded-4 p-5" data-aos="fade-up" data-aos-offset="100">
        <div class="row d-flex flex-column-reverse flex-lg-column flex-xl-row justify-content-start align-items-center">
            ...
            <div class="col-sm-12 col-xl-5 d-flex justify-content-center mb-5 mb-xl-0">
                ...
                <img class="img-fluid" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" data-aos="fade-left" data-aos-offset="100">
            </div>
