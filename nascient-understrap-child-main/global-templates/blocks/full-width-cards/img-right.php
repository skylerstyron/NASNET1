...
<?php while (have_rows('image_right_content_left_card')) : the_row(); ?>
    ...
    <div class="d-flex justify-content-around align-items-center">
        <div class="col-10 card container-card rounded-4 p-5 mt-5" data-aos="fade-up" data-aos-offset="<?php echo $i; $i++; ?>0">

            <div class="row d-flex flex-column-reverse flex-xl-row justify-content-start align-items-center">

                <div class="col-md-12 col-xl-6 mx-auto">
                    <h2 class="fs-1 mb-4" data-aos="fade-right" data-aos-offset="<?php echo $i; $i++; ?>0"><?php the_sub_field('title'); ?></h2>
                ...
                <div class="col-sm-12 col-xl-5 d-flex justify-content-center mb-5 mb-xl-0">
                    ...
                    if ($image) : ?>
                        <img class="img-fluid h-lg-25" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" data-aos="fade-left" data-aos-offset="<?php echo $i; $i++; ?>0">
                    <?php endif; ?>
                </div>
